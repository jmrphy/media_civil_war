...
![plot of chunk longrunplot](figure/longrunplot.pdf) 
...
data:  unit$mdi
CIPS test = -2.064, lag order = 2, p-value = 0.1
alternative hypothesis: Stationarity
