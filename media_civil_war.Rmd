...
```{r full_panel_plot, fig.cap='Disaggregated media density and all civil war onsets over time, by country', fig.height=10, fig.width=9, cache=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
