...
Previous research on the relationship between mass media and civil war onset is puzzling for two reasons. From Rwanda and Yugoslavia in the early 1990s to Libya and Syria in 2011, civil wars often involve the use of mass media for belligerent purposes. While this has led some scholars to argue that mass media play a unique causal role in the outbreak of civil wars, others have argued that the effect of mass media has been overstated. To make the puzzle even more accute, the most comprehensive quantitative evidence to date suggests that mass media decreases the likelihood of civil war onset. Yet, the exponential increase in civil wars around the world beginning in the 1960s coincides with a similar increase in mass media at the global level. While the international-level pattern does not formally contradict the finding of a negative relationship between mass media and civil war within countries (as the pacific effects of increasing mass media could have been outweighed by other factors increasing the probability of civil wars), the discrepancy nonetheless points to what remains dissatisfying about current accounts of the relationship between civil war and mass media. If mass media decrease the probability of civil war, this contributes very little to understanding the troublingly high prevalence of civil war around the world in recent decades.

This research note provides a novel theory of the relationship between mass media and civil war which accounts for these apparently contradictory facts. Paradoxically, it is precisely because dense mass media systems strengthen the state that the first appearance and early spread of mass media within a country should *encourage* insurgencies. When mass media spreads enough within a country to constitute a mass communications system, this triggers communicative economies of scale which so increase the payoffs of controlling the state that it incentivizes violent insurgency before the *ex ante* holders of state power become normatively locked-in and effectively impossible to challenge.^[As discussed below, beyond a certain threshold of mass media the probability of observing a civil war is effectively zero.] A key point of my account, however, is that the economies of scale peculiar to information production within a mass communications system represent a qualitative change which occurs only at a certain threshold of mass media density. This is why there should be an inflection point at which the effect of mass media changes from positive to negative at a certain point in its range. The counter-intuitive implication is that the very pacifying effect of a mass communications system charges the early spread of mass media with an increasingly bellicose effect until the threshold of mass communications is crossed.

To compare the non-linear "war before peace" theory to the linear, monotonic, general pacification theory, I deduce three observable implications unique to the non-linear theory, one of which applies to a new level of analysis (the international level) and is outside the sample which originally generated evidence for the general pacification theory.

article proceeds as follows.

i explain the problem further, focusing on the most recent quantitaive work

i provide my own account, drawing on mass communications research

i generate 3 observable implications which are unique to my theory
...
Although Warren shows that many statistical tests are consistent with this theory, which I will henceforth call the "general pacification theory," it remains puzzling for two reasons.  First, if higher levels of mass media density decrease the likelihood of civil war, it is puzzling that in modern history, the international system's most rapid and widespread proliferation of mass media density has coincided with its most dramatic increases in civil war. If mass media density decreases the likelihood of civil war as strongly and robustly as Warren argues, then why has the global proliferation of mass media since 1945 had no appreciable effect in pacifying the global prevalence of civil war? Of course it is possible that other drivers of civil war onset have simply outweighed the pacifying effect of mass media; nonetheless, that an exponential increase in civil wars around the world coincides so closely with an exponential increase in mass media density is, at least, starkly puzzling fact given the general pacification theory.
...
```{r disaggregated-nonlinear, cache=FALSE, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.width=8, fig.height=10}
par(mfrow=c(3,1))
