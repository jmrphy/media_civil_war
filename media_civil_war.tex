...
E-mail: hlavac at fas.harvard.edu \% Date and time: Thu, Jun 26, 2014 -
12:05:35
...
difficulty of drawing inferences from multiple smoothed regression
splines, the following section proceeds with traditional parametric
logistic regressions on subsets of the sample suggested by the
semi-parametric model. The second observable implication is also
considered.
...
adjustment for rare-events (Gary King and Zeng 2001).\footnote{Traditional
  ...
  onsets in the full sample and 63 (3.47\%) in the subset of low-MDI
  country years.}
